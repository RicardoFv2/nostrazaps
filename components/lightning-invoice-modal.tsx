...
export function LightningInvoiceModal({
  ...
  const handleSubmit = async () => {
    ...
    // Basic validation for Lightning invoice (lnbc prefix)
    if (!invoice.toLowerCase().startsWith("lnbc")) {
      setError("Invoice inválido. Debe comenzar con 'lnbc'")
      return
    }
          ...
          <AlertDialogDescription className="text-left space-y-3">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
              ...
              <ol className="text-sm text-blue-700 dark:text-blue-300 space-y-1 list-decimal list-inside">
                ...
                <li>Copia el invoice (comienza con "lnbc")</li>
